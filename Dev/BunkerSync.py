...
def main():
    ...
    parser.add_argument('-i', '--internal', action='store',
    ...
    parser.add_argument('-ib', '--internal_branch', default=None, type=str,
                        help='The name of the branch in the internal repository.')
    parser.add_argument('-eb', '--external_branch', default=None, type=str,
                        help='The name of the branch in the external repository.')
    parser.add_argument('-bb', '--branch_base', default=None, type=str,
